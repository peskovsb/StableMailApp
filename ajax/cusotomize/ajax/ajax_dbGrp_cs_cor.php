...
//--VARS
$FirstNameGroup = trim($_GET['FirstNameGroup']);
...
class mainpage_query{
	...
	function getAllfromtable($FirstNameGroup,$nameGroup,$grp_createuser,$grp_view,$grp_view2,$grp_correct,$grp_correct2,$grp_createuser2){
		...
		if($this->arrBest['level_id'] && $FirstNameGroup != $nameGroup){
...
$arrGetter = $getData ->getAllfromtable($FirstNameGroup,$nameGroup,$grp_createuser,$grp_view,$grp_view2,$grp_correct,$grp_correct2,$grp_createuser2);
