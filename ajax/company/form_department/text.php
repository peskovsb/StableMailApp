...
$db = new DatabaseItDept();
	...
	$sql4 = 'SELECT * FROM executive WHERE executive_id = :idchoose';
	
	$tb = $db->connection->prepare($sql4);
	$tb->execute(array(':idchoose'=>trim($_POST['staff_executive'])));
...
';}
if(trim($getData4['executive_name'])){$message .= 'Руководитель: '.$getData4['executive_name'].'
';}
